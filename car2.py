...
print("Техобслуживание автомобилей")
print(" ")
...
print(f"{car1.brand} {car1.start_engine(1)} с первого раза")
print(f"{car2.brand} {car2.start_engine(1)} легко")
print(f"{car3.brand}, ёбаный в рот, опять {car3.start_engine(0)}")
print(" ")
print("Проверяем мотор спецтехники")
print(f"{fire_car1.brand} {fire_car1.start_engine(1)} с первого раза")
print(f"{fire_car2.brand} {fire_car2.start_engine(1)} легко")
